...
def run_marker(input_ticker_year_path:str,ticker:str,year:str,batch_multiplier:int=2):
    # subprocess.run(["ls", "-l"]) 
    ...
    for input_path in os.listdir(input_ticker_year_path):
        ...
        full_text, images, out_meta = convert_single_pdf(input_path, model_lst, langs=["English"], batch_multiplier=batch_multiplier)
