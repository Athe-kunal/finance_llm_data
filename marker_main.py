...
parser.add_argument(
    "-ia", "--include_amends", type=str, help="Whether to include amendment files"
)
parser.add_argument(
    "-ft", "--filing_types", type=str, help="Filings types separated by commas"
)
...
parser.add_argument(
    "-bm", "--batch_multiplier", type=int, default=2, help="Number of pages to process"
)

args = parser.parse_args()

assert args.include_amends in [
    "true",
    "false",
], "The include_amends argument is either true or false"
...
html_urls, metadata_json, input_ticker_year_path = sec_save_pdfs(
    args.ticker, args.year, filings_types_list, include_amends
)
